...
import urllib
CLIENT_ID = "LzDLAxI7b2vDJSmRYuL8ry0VABo8AAel" # Fill this in with your client ID
CLIENT_SECRET = "VrzchNFWMq0Cl2mg" # Fill this in with your client secret
...
def make_authorization_url():
    ...
    params = {"client_id": CLIENT_ID,
              ...
              "duration": "temporary",
              "scope": "identity"}
    url = "https://sandbox-api.dexcom.com" + urllib.urlencode(params)
    return url
...
def get_username(access_token):
    ...
    response = requests.get("https://sandbox-api.dexcom.com", headers=headers)
